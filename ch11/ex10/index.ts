...
export function getDays(year: number, month: number): number {
    ...
    let startDate = newDate.setFullYear(year, month - 1, 1);
    let endDate = newDate.setFullYear(year, month, 1);
...
export function getLocaleDayOfWeek(date: string): string {
...
console.log(getLocaleDayOfWeek("2025-01-01")); // 水曜日
console.log(getLocaleDayOfWeek("2025-12-25")); // 木曜日
